      ...
      <Card>
        <CardWrapper>
          ...
          <NameAndAmount>
            ...
            <Amount>
              N
              {walletData?.walletBalance?.toFixed(2) === null
                ? 0.0
      ...
      <Card>
        <CardWrapper>
          ...
          <NameAndAmount>
            ...
            <Amount>
              N
              {walletData?.totalSavings?.toFixed(2) === null
                ? 0.0
      ...
      <Card>
        <CardWrapper>
          ...
          <NameAndAmount>
            ...
            <Amount>
              N
              {walletData?.totalInvestment?.toFixed(2) === null
                ? 0.0
                : walletData?.totalInvestment?.toFixed(2)}
            </Amount>
          </NameAndAmount>
        </CardWrapper>
      </Card>
