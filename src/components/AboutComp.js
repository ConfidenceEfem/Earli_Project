...
const AboutComp = ()=>{
    return(
        ...
        <AboutContent>
        At Earli, we pride ourselves in creating wealth for youngsters. We believe starting your financial freedom journey early enough will give you the leading advantage in attaining wealth at a young age. <br/>
        We created Earli to help parents start investing and saving towards the future of their children
        </AboutContent>
